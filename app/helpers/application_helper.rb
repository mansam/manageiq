module ApplicationHelper
  ...
  def display_adv_search?
    %w(auth_key_pair_cloud availability_zone cloud_volume container_group container_node container_service
  ...
  def render_listnav_filename
    if @lastaction == "show_list" && !session[:menu_click] &&
      ...
      "vm"
    elsif %w(action auth_key_pair_cloud availability_zone cim_base_storage_extent
             cloud_tenant cloud_volume condition container_group container_route container_project
  ...
  def show_adv_search?
    show_search = %w(auth_key_pair_cloud availability_zone cim_base_storage_extent cloud_volume
                     container_group container_node container_service container_route container_project
                     container_replicator container_image container_image_registry
