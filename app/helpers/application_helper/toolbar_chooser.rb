class ApplicationHelper::ToolbarChooser
  ...
  def center_toolbar_filename_classic
    ...
    if ((@lastaction == "show" && @view) ||
      ...
      unless @in_a_form
        if %w(availability_zone cloud_object_store_object cloud_tenant cloud_volume container_group container_node container_service 
              ems_cloud ems_cluster ems_container container_project container_route container_replicator container_image
