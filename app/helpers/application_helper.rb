module ApplicationHelper
  ...
  def display_adv_search?
    %w(availability_zone cloud_object_store_object cloud_volume container_group container_node container_service
  ...
  GTL_VIEW_LAYOUTS = %w(action availability_zone cim_base_storage_extent cloud_object_store_object cloud_tenant cloud_volume condition container_group
                        container_route container_project container_replicator container_image container_image_registry
  ...
  def render_listnav_filename
    if @lastaction == "show_list" && !session[:menu_click] &&
       %w(cloud_object_store_object cloud_volume container_node container_service ems_container container_group ems_cloud ems_cluster
          container_route container_project container_replicator container_image container_image_registry
      ...
      "vm"
    elsif %w(action availability_zone cim_base_storage_extent cloud_tenant cloud_object_store_object cloud_volume condition container_group
             container_route container_project container_replicator container_image container_image_registry
  ...
  def show_adv_search?
    show_search = %w(availability_zone cim_base_storage_extent cloud_object_store_object cloud_volume container_group container_node container_service
                     container_route container_project container_replicator container_image container_image_registry
